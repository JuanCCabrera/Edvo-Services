...
var query14 = client.query('create table recommendation_target(recomID integer unique not null primary key references recommendations(recomID), strategies boolean, material boolean, timeManagement boolean, tech boolean, instructions boolean)');
