...
var query5 = client.query('create table class_info(userID text references users(userID), classInfoID serial not null unique, subject varchar(100), format varchar(10), language varchar(20), level varchar(25), groupsize varchar(7), topicA varchar(50), topicB varchar(50), topicC varchar(50), primary key (userID, classInfoID))');
...
var query11 = client.query('create table recommendations(recomID serial unique not null primary key, location varchar(150), subject varchar(100), spanish boolean, english boolean, type varchar(20), schoolType varchar(20), format varchar(10), groupsize varchar(7), level varchar(25), mentorID text references users(userID), active boolean)');
